...
public class Activity16 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View button116 = findViewById(R.id.imageButton16);
        button116.setOnClickListener(this);
    }

    public void SeventeenthActivity(View v) {
